...
import { TableFilterModule, VerbenDialogueModule } from 'verben-ng-ui/src/public-api';
...
@NgModule({
  ...
  imports: [ RouterModule.forChild(routes),CommonModule,VerbenDialogueModule,TableFilterModule],
})
