...
@NgModule({
  ...
  imports: [CommonModule, FormsModule, VerbenaBadgeModule, VerbenaButtonModule, VerbenaSwitchModule, VerbenaTextareaModule, verbenaComponentRoutingModule, VerbenaInputModule, TooltipComponent, ValidationModule],
})
